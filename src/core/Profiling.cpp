...
const std::array<const char*, kScopeCount> kScopeNames = {
    ...
    "enemy.ai.decision",
    "enemy.ai.movement",
    "enemy.movement.separation_probe",
    "enemy.movement.overlap_check",
    "enemy.movement.overlap.is_blocked",
    "enemy.movement.overlap.separation_turn",
    "enemy.movement.overlap.turn_valid",
    "enemy.movement.wall_check",
    "enemy.ai.firing",
    ...
    "frame.render.world.enemies.cull",
    "frame.render.world.enemies.draw",
    "frame.render.world.effects",
    "frame.render.world.effects.projectiles",
    "frame.render.world.effects.explosion",
    "frame.render.world.effects.player_fallback",
    "frame.render.hud",
